...
EF:RegisterEncounter(1778, function()
	...
	self:RegisterEvent("INSTANCE_ENCOUNTER_ENGAGE_UNIT", function()
		...
		for i = 1, 4 do
			...
			if self:GetNPCID(GUID) == "94515" then  -- Siegemaster Mar'tak
...
EF:RegisterEncounter(1794, function()
	...
	self:RegisterEvent("INSTANCE_ENCOUNTER_ENGAGE_UNIT", function()
		...
		if self:GetNPCID(GUID) == 90296 then  -- Soulbound Construct
	...
	self:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED", EF:CheckForOverkill)
end)
